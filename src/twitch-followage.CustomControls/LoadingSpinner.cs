...
namespace twitch_followage.CustomControls
{
	/// <summary>
	...
	/// to be used:
	///
	///     xmlns:MyNamespace="clr-namespace:twitch_followage.CustomControls"
	///
	///
	...
	/// to be used:
	///
	///     xmlns:MyNamespace="clr-namespace:twitch_followage.CustomControls;assembly=twitch_followage.CustomControls"
	///
